  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div>
          ...
          className="text-[#FF0000]">Arnav</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>A Full Stack
           Developer 
          with a passion for <br className="sm:block hidden"/> creating
            beautiful and responsive web pages</p>
      </div>
